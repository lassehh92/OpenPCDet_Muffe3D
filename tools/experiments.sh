...
do
    ...
    do
        ...
        python train.py --cfg_file cfgs/custom_models/pointrcnn_base.yaml --epochs $EPOCH --batch_size $BATCH_SIZE --extra_tag "exp_${EPOCH}_epochs_${BATCH_SIZE}_batch" > "logs/exp_${EPOCH}_${BATCH_SIZE}.log" 2>&1
