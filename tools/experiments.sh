...
do
    ...
    do
        ...
        do
            ...
            python train.py --cfg_file cfgs/custom_models/pointrcnn_base_radii_range.yaml --epochs $EPOCH --batch_size $BATCH_SIZE --lr $LR --extra_tag "exp_${EPOCH}_epochs_${BATCH_SIZE}_batch_lr_${LR}" 2>&1 | tee "logs/exp_${EPOCH}_${BATCH_SIZE}_lr_${LR}.log"
